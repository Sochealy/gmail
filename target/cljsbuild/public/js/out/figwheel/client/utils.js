...
return (new CustomEvent(event_name,(function (){var obj34507 = {"detail":data};
return obj34507;
})()));
} else {
...
var f = (function (){var pred__34514 = cljs.core._EQ_;
var expr__34515 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34514.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34515))){
return ((function (pred__34514,expr__34515){
return (function (p1__34508_SHARP_){
return console.warn(p1__34508_SHARP_);
});
;})(pred__34514,expr__34515))
} else {
if(cljs.core.truth_(pred__34514.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34515))){
return ((function (pred__34514,expr__34515){
return (function (p1__34509_SHARP_){
return console.debug(p1__34509_SHARP_);
});
;})(pred__34514,expr__34515))
} else {
if(cljs.core.truth_(pred__34514.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34515))){
return ((function (pred__34514,expr__34515){
return (function (p1__34510_SHARP_){
return console.error(p1__34510_SHARP_);
});
;})(pred__34514,expr__34515))
} else {
return ((function (pred__34514,expr__34515){
return (function (p1__34511_SHARP_){
return console.log(p1__34511_SHARP_);
});
;})(pred__34514,expr__34515))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34518){
...
var opts = map__34519__$1;
var eval_fn = cljs.core.get.call(null,map__34519__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34521_SHARP_);
});})(new_def))
);
...
return (function (p__34522){
var vec__34523 = p__34522;
var ky = cljs.core.nth.call(null,vec__34523,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1541057583996
