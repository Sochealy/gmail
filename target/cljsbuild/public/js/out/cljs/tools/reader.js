...
var G__34188 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__34188;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__34189 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__34189,ch);
...
if(("\\" === ch__$1)){
var ch_34190__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_34190__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_34190__$2);
} else {
}

var G__34191 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__34191;
continue;
}
}
...
var vec__34199 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__34199,(0),null);
var start_column = cljs.core.nth.call(null,vec__34199,(1),null);
...
var G__34202 = cljs.core.conj_BANG_.call(null,a,form);
a = G__34202;
continue;
}
}
...
var _STAR_read_delim_STAR_34203 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_34203;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__34204 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__34204,(0),null);
var start_column = cljs.core.nth.call(null,vec__34204,(1),null);
...
var vec__34207 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__34207,(0),null);
var end_column = cljs.core.nth.call(null,vec__34207,(1),null);
...
var vec__34210 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__34210,(0),null);
var start_column = cljs.core.nth.call(null,vec__34210,(1),null);
...
var vec__34213 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__34213,(0),null);
var end_column = cljs.core.nth.call(null,vec__34213,(1),null);
...
var vec__34216 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__34216,(0),null);
var start_column = cljs.core.nth.call(null,vec__34216,(1),null);
...
var vec__34219 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__34219,(0),null);
var end_column = cljs.core.nth.call(null,vec__34219,(1),null);
...
var sb = (function (){var G__34222 = (new goog.string.StringBuffer());
G__34222.append(initch);
...
var G__34224 = (function (){var G__34223 = sb;
G__34223.append(ch);

return G__34223;
})();
var G__34225 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__34224;
ch = G__34225;
continue;
}
...
switch (G__34228) {
case "\\":
var G__34232 = (function (){var G__34229 = sb;
G__34229.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__34229;
})();
var G__34233 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__34232;
ch = G__34233;
continue;
...
break;
default:
var G__34234 = (function (){var G__34230 = sb;
G__34230.append(ch);

return G__34230;
})();
var G__34235 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__34234;
ch = G__34235;
continue;
...
var vec__34236 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__34236,(0),null);
var end_column = cljs.core.nth.call(null,vec__34236,(1),null);
...
var vec__34244 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__34244,(0),null);
var column = cljs.core.nth.call(null,vec__34244,(1),null);
...
var vec__34249 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__34249,(0),null);
var column = cljs.core.nth.call(null,vec__34249,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__34254 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var vec__34257 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__34257,(0),null);
var end_column = cljs.core.nth.call(null,vec__34257,(1),null);
...
var G__34260 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__34260,true,null,opts,pending_forms);
...
var G__34261 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__34261)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__34261)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__34261)){
...
var _STAR_suppress_read_STAR_34262 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_34262;
}});
...
var G__34263 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__34263,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__34263,rdr,first_line);
...
var G__34267 = matched;
var G__34268 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__34267;
finished = G__34268;
continue;
} else {
...
var arg_env34270 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__34271 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__34271,"(");
...
var G__34272 = (i + (1));
var G__34273 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3949__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env34270;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__34274 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__34274);
...
var G__34275 = cljs.core.next.call(null,s__$1);
var G__34276 = ret;
s__$1 = G__34275;
r = G__34276;
continue;
...
var G__34277 = cljs.core.next.call(null,s);
var G__34278 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__34277;
key_vals = G__34278;
continue;
} else {
...
var gensym_env34282 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env34282;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__34283 = token;
var G__34283__$1 = (((G__34283 == null))?null:cljs.core.subs.call(null,G__34283,(1)));
var G__34283__$2 = (((G__34283__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__34283__$1));
var G__34283__$3 = (((G__34283__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__34283__$2));
var G__34283__$4 = (((G__34283__$3 == null))?null:cljs.core.symbol.call(null,G__34283__$3));
if((G__34283__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__34283__$4);
}
})():(function (){var G__34284 = token;
var G__34284__$1 = (((G__34284 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__34284));
if((G__34284__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__34284__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__34295,reader){
...
var opts = map__34296__$1;
var eof = cljs.core.get.call(null,map__34296__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4531__auto___34304 = arguments.length;
var i__4532__auto___34305 = (0);
while(true){
if((i__4532__auto___34305 < len__4531__auto___34304)){
args__4534__auto__.push((arguments[i__4532__auto___34305]));

var G__34306 = (i__4532__auto___34305 + (1));
i__4532__auto___34305 = G__34306;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq34302){
var G__34303 = cljs.core.first.call(null,seq34302);
var seq34302__$1 = cljs.core.next.call(null,seq34302);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34303,seq34302__$1);
});


//# sourceMappingURL=reader.js.map?rel=1541057583152
