...
var i_31328 = (0);
while(true){
if((i_31328 < arr.length)){
(arr[i_31328] = null);

var G__31329 = (i_31328 + (1));
i_31328 = G__31329;
continue;
} else {
}
...
var i_31338 = (self__.level + (1));
while(true){
if((i_31338 <= (new_level + (1)))){
(update[i_31338] = self__.header);
...
var i_31340 = (0);
while(true){
if((i_31340 <= self__.level)){
var links_31341 = (update[i_31340]).forward;
if((x__$1 === (((i_31340 < links_31341.length))?(links_31341[i_31340]):null))){
(links_31341[i_31340] = (x__$1.forward[i_31340]));
...
if(!((nx == null))){
var G__31345 = nx;
var G__31346 = (level__$1 - (1));
x = G__31345;
level__$1 = G__31346;
continue;
} else {
var G__31347 = x;
var G__31348 = (level__$1 - (1));
x = G__31347;
level__$1 = G__31348;
continue;
}
...
//# sourceMappingURL=timers.js.map?rel=1541057577563
