...
var o28153 = temp__5455__auto__;
var temp__5455__auto____$1 = (o28153["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o28154 = temp__5455__auto____$1;
return (o28154["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27263__auto__ = f;
return (o__27263__auto__["toString"]).call(o__27263__auto__);
} else {
return "";
}
}catch (e28155){var _ = e28155;
return "";
}});
...
try{var o__27263__auto___28157 = t;
(o__27263__auto___28157["cljs$lang$ctorPrWriter"]).call(o__27263__auto___28157,t,writer);
}catch (e28156){var __28158 = e28156;
}
...
var char_code = (function (){var o__27263__auto__ = (new String(char$));
return (o__27263__auto__["charCodeAt"]).call(o__27263__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27263__auto__ = String;
return (o__27263__auto__["fromCharCode"]).call(o__27263__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28159 = num_code;
switch (G__28159) {
case (1):
return (185);
...
var o__27263__auto__ = String;
return (o__27263__auto__["fromCharCode"]).call(o__27263__auto__,superscript_code);
});
/**
...
}catch (e28161){var _e__27270__auto__ = e28161;
return false;
}})())){
...
var vec__28162 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__28162,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o28165 = temp__5455__auto__;
var temp__5455__auto____$1 = (o28165["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o28166 = temp__5455__auto____$1;
return (o28166["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___28173 = arguments.length;
var i__4532__auto___28174 = (0);
while(true){
if((i__4532__auto___28174 < len__4531__auto___28173)){
args__4534__auto__.push((arguments[i__4532__auto___28174]));

var G__28175 = (i__4532__auto___28174 + (1));
i__4532__auto___28174 = G__28175;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28169){
var vec__28170 = p__28169;
var ns_detector = cljs.core.nth.call(null,vec__28170,(0),null);
...
var G__28176 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__28177 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__28176;
remaining_tokens = G__28177;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28167){
var G__28168 = cljs.core.first.call(null,seq28167);
var seq28167__$1 = cljs.core.next.call(null,seq28167);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28168,seq28167__$1);
});
...
var vec__28181 = cljs.core.split_with.call(null,(function (p1__28180_SHARP_){
return cljs.core.not_EQ_.call(null,p1__28180_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__28181,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__28181,(1),null);
...
var vec__28184 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__28184,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__28184,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__28187 = cljs.core.rest.call(null,remaining_tokens);
var G__28188 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__28187;
name_tokens = G__28188;
continue;
} else {
...
var vec__28191 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__28191,(0),null);
var arity = cljs.core.nth.call(null,vec__28191,(1),null);
var vec__28194 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__28194,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__28194,(1),null);
var vec__28197 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__28197,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__28197,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__28197,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__28197,(3),null);
...
var vec__28203 = result;
var munged_ns = cljs.core.nth.call(null,vec__28203,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__28203,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__28203,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__28203,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__28203,(4),null);
var arity = cljs.core.nth.call(null,vec__28203,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__28207 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__28207,(0),null);
var args = cljs.core.nth.call(null,vec__28207,(1),null);
var vec__28210 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__28210,(0),null);
var name = cljs.core.nth.call(null,vec__28210,(1),null);
...
var G__28213 = (arity + (1));
var G__28214 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28215){
var vec__28216 = p__28215;
var arity = cljs.core.nth.call(null,vec__28216,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__28216,(1),null);
...
return cljs.core.get.call(null,arities,p1__28219_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__28220_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___28227 = arguments.length;
var i__4532__auto___28228 = (0);
while(true){
if((i__4532__auto___28228 < len__4531__auto___28227)){
args__4534__auto__.push((arguments[i__4532__auto___28228]));

var G__28229 = (i__4532__auto___28228 + (1));
i__4532__auto___28228 = G__28229;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28223){
var vec__28224 = p__28223;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__28224,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28221){
var G__28222 = cljs.core.first.call(null,seq28221);
var seq28221__$1 = cljs.core.next.call(null,seq28221);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28222,seq28221__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__28232__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__28232__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__28232__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__28232__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28233 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__28233,(0),null);
var fn_name = cljs.core.nth.call(null,vec__28233,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__28233,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__28233,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__28233,(4),null);
var arity = cljs.core.nth.call(null,vec__28233,(5),null);
...
var o__27263__auto__ = f;
return (o__27263__auto__["getBasis"]).call(o__27263__auto__);
});
/**
...
}catch (e28237){var _e__27270__auto__ = e28237;
...
var G__28238 = (obj[cljs.core.first.call(null,path)]);
var G__28239 = cljs.core.rest.call(null,path);
obj = G__28238;
path = G__28239;
continue;
} else {
...
return (function (accum,p__28240){
var vec__28241 = p__28240;
var bit = cljs.core.nth.call(null,vec__28241,(0),null);
var protocol = cljs.core.nth.call(null,vec__28241,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28244){
...
var selector = cljs.core.nth.call(null,vec__28245,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__28250,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__28250,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__28250,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__28248_SHARP_){
return (obj[cljs.core.first.call(null,p1__28248_SHARP_)]);
});})(name,sorted_matches,vec__28250,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1541057570199
