...
return cljs.core.boolean$.call(null,(function (){var or__3949__auto__ = cljs.core.some.call(null,cljs.core.some_fn.call(null,cljs.core.nil_QMARK_,meta_merge.core.displace_QMARK_,meta_merge.core.replace_QMARK_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [left,right], null));
...
if(cljs.core.truth_((function (){var and__3938__auto__ = meta_merge.core.displace_QMARK_.call(null,left);
...
if(cljs.core.truth_((function (){var and__3938__auto__ = meta_merge.core.replace_QMARK_.call(null,left);
if(cljs.core.truth_(and__3938__auto__)){
...
if(cljs.core.truth_((function (){var or__3949__auto__ = meta_merge.core.displace_QMARK_.call(null,left);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
return meta_merge.core.replace_QMARK_.call(null,right);
...
if(cljs.core.truth_((function (){var or__3949__auto__ = meta_merge.core.replace_QMARK_.call(null,left);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
return meta_merge.core.displace_QMARK_.call(null,right);
...
args_arr__4546__auto__.push((arguments[i__4532__auto___29905]));
...
if(cljs.core.truth_(meta_merge.core.different_priority_QMARK_.call(null,left,right))){
...
if(cljs.core.truth_((function (){var or__3949__auto__ = new cljs.core.Keyword(null,"prepend","prepend",342616040).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,left));
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
/** @this {Function} */
meta_merge.core.meta_merge.cljs$lang$applyTo = (function (seq29899){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29900,G__29901,seq29899__$2);
});

meta_merge.core.meta_merge.cljs$lang$maxFixedArity = (2);


//# sourceMappingURL=core.js.map?rel=1541057575880
