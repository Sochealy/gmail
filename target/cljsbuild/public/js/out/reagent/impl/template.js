...
var G__27086 = o;
(G__27086[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__27088__i < G__27088__a.length) {G__27088__a[G__27088__i] = arguments[G__27088__i + 0]; ++G__27088__i;}
  args = new cljs.core.IndexedSeq(G__27088__a,0,null);
} 
...
var args = cljs.core.seq(arglist__27089);
...
var G__27090 = o;
(G__27090[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__27095 = props;
var G__27095__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__27095,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__27095);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__27095__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__27096){
...
var props = map__27097__$1;
var class$ = cljs.core.get.call(null,map__27097__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__27097,map__27097__$1,props,class$){
return (function (c){
...
});})(map__27097,map__27097__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__27099){
...
var on_write = cljs.core.get.call(null,map__27100__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__27100,map__27100__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__27100,map__27100__$1,on_write))
);
} else {
...
var G__27103 = jsprops;
(G__27103["defaultValue"] = value);

(G__27103["onChange"] = ((function (G__27103,v,value,on_change){
return (function (p1__27102_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__27102_SHARP_);
});})(G__27103,v,value,on_change))
);
...
var vec__27106 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__27106,(0),null);
var id = cljs.core.nth.call(null,vec__27106,(1),null);
var class$ = cljs.core.nth.call(null,vec__27106,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___27110 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___27110 == null)){
} else {
var key_27111 = temp__5461__auto___27110;
(jsprops["key"] = key_27111);
}
...
var temp__5461__auto___27112 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___27112 == null)){
} else {
var key_27113 = temp__5461__auto___27112;
reagent.impl.template.oset.call(null,jsprops,"key",key_27113);
}
...
var G__27114 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__27114["name"] = c);
...
var len__4531__auto___27119 = arguments.length;
var i__4532__auto___27120 = (0);
while(true){
if((i__4532__auto___27120 < len__4531__auto___27119)){
args__4534__auto__.push((arguments[i__4532__auto___27120]));

var G__27121 = (i__4532__auto___27120 + (1));
i__4532__auto___27120 = G__27121;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq27117){
...
break;
default:
var G__27124 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__27124;
continue;
...
var n__4408__auto___27126 = a.length;
var i_27127 = (0);
while(true){
if((i_27127 < n__4408__auto___27126)){
(a[i_27127] = reagent.impl.template.as_element.call(null,(a[i_27127])));
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___27129 = a.length;
var i_27130 = (0);
while(true){
if((i_27130 < n__4408__auto___27129)){
var val_27131 = (a[i_27130]);
if(((cljs.core.vector_QMARK_.call(null,val_27131)) && ((reagent.impl.template.key_from_vec.call(null,val_27131) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_27130] = reagent.impl.template.as_element.call(null,val_27131));

var G__27132 = (i_27130 + (1));
i_27130 = G__27132;
continue;
} else {
}
...
var ctx = ({});
var vec__27133 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__27133,(0),null);
var derefed = cljs.core.nth.call(null,vec__27133,(1),null);
...
var G__27136 = (cljs.core.count.call(null,argv) - first_child);
switch (G__27136) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__27136){
...
//# sourceMappingURL=template.js.map?rel=1541057568737
